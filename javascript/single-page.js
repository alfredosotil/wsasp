(function ($) {
    ...
    jQuery(document).on('ready', function () {
        ...
        new Swiper('.swiper-container-portfolios', {pagination: '.swiper-pagination-portfolios', a11y: true, keyboardControl: true, autoHeight: true, speed: 800, paginationClickable: true});
    });
